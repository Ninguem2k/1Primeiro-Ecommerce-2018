...
<html lang="pt-br">
    ...
    <head>
        ...
        <link rel="stylesheet" href="../assets/acss/templatemo.css">
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="col-12 col-md-8 mb-8 m-auto">                
                <form name="imagens" enctype="multipart/form-data" action="CONF-PRODUTO-CADASTRAR.php" method="POST">
                    ...
                    <div class="card text-center text-dark h-100 ">
                        ...
                        <input type="text" name="LINK_AFILIADO" value="" />
                        <label>AVALIAÇÂO</label> <i class="text-warning fa fa-star"></i>                               
                        <input type="text" name="AVALIAÇÃO" value="" />      
                        <label>VALOR R$</label>
        ...
        if (!is_dir($destino)) {
            ...
            if (isset($_POST['ok'])) {
                ...
                if ($UPIcerto == TRUE) {
                    ...
                    $value[7] = $_POST['HOMEM'];
                    $value[8] = $_POST['MULHER'];
                    $value[9] = $_POST['CRIANÇA'];
                    $value[10] = $_POST['ADULTO'];
                    $value[11] = $_POST['MELHOR_IDADE'];
                   
                    
                    $query = "INSERT INTO `produtos` (`TITULO`,`VALOR`,`AVALIAÇÃO`,`DESCRIÇÃO`,`IMAGEM`,`LINK_AFILIADO`,`HOMEM`, `MULHER`, `CRIANÇA`, `ADULTO`, `MELHOR_IDADE`) VALUES (  '$value[1]','$value[2]','$value[3]','$value[4]','$value[5]','$value[6]','$value[7]','$value[8]','$value[9]','$value[10]','$value[11]')";
