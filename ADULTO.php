...
//        $id_sub_categoria = '1';
        ...
        $result_empresa = "SELECT TITULO FROM produtos WHERE ADULTO = '1'";
//        $result_empresa = "SELECT TITULO FROM produtos WHERE HOMEM = '$id_categoria' AND CRIANÇA = '$id_sub_categoria'";
        ...
        $result_empresas = "SELECT * FROM produtos WHERE   ADULTO = '1' LIMIT $inicio, $qnt_result_pg";
        ...
        <div class="container py-5">
            ...
            <div div="row">
                <ul class="pagination pagination-lg justify-content-end">
                    <li class="page-item">
                        <a class="page-link active rounded-0 mr-2 shadow-sm border-top-0 border-left-0" href="ADULTO.php?pagina=1" tabindex="-1">Primeira</a>
                    </li>
                    ...
                    for ($iPag = $pagina - $MaxLinks; $iPag <= $pagina - 1; $iPag++) {
                        if ($iPag >= 1) {
                            echo '   '
                            . '<li '
                            . 'class = "page-item"><a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark" href="ADULTO.php?pagina=', $iPag, '">', $iPag, '</a>'
                            . '</li> ';
                        }
                    }
                    ?>
                    ...
                    for ($dPag = $pagina + 1; $dPag <= $pagina + $MaxLinks; $dPag++) {
                        if ($dPag <= $quantidade_pg) {
                            echo '   '
                            . '<li '
                            . 'class = "page-item"><a class="page-link rounded-0 shadow-sm border-top-0 border-left-0 text-dark" href="ADULTO.php?pagina=', $dPag, '">', $dPag, '</a>'
                            . '</li> ';
                        }
                    }
                    ?>
                    ...
                    <li class="page-item">
                        <?php
                        echo '<a class="page-link active rounded-0 mr-2 shadow-sm border-top-0 border-left-0 " href="ADULTO.php?pagina= ', $quantidade_pg, ' " tabindex="-1">Ultimo</a>';
                        ?>
                    </li>              
                </ul>
            </div>
    ...
    <footer class="bg-dark" id="tempaltemo_footer">
        <div class="container">
            ...
            <div class="row text-light mb-4">
                ...
                <div class="col-auto">
                    <form action="ADULTO.php" name="enviar" method="POST">
